...
/* =====================================================================
   ...
   Generated from the design system. Mirrors styles/tokens.css 1:1.
   Theme switches via the `data-theme` attribute on <html>:
  ...
  theme: {
    extend: {
      tokens: {
        ...
        fonts: {
          display: { value: "Sora, system-ui, sans-serif" },
          sans: { value: '"Plus Jakarta Sans", system-ui, sans-serif' },
      ...
      // -------- Semantic tokens — resolve per theme (base = dark) --------
      semanticTokens: {
        colors: {
